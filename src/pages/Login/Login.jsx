        ...
        <div className={cx("wrapper")}>
          ...
          <div className={cx("col-lg")}>
            <div className={cx("customer-actions__wrapper")}>
              <div
                className={cx(
                  "customer-actions__form",
                  openForgotPassword && "show"
                )}
              >
                  ...
                  <div className={cx("customer-login")}>
                    ...
                    {activeSignup && (
                      <>
                        <Input
                          type="checkbox"
                          label="Đăng kí nhận thông tin khuyến mãi"
                        />
                        <div className={cx("form-desc")}>
                          Bằng cách tạo tài khoản ở Maison là bạn đồng ý với các{" "}
                          <span>
                            Chính sách Bảo mật và Điều khoản - Điều kiện.
                          </span>
                        </div>
                      </>
                    )}
                ...
                <div className={cx("forgot-password")}>
                  <div className={cx("forgot-password__top")}>
                    ...
                    <div className={cx("form-desc")}>
                      Vui lòng nhập email của bạn ở đây để nhận hướng dẫn đặt
                      lại mật khẩu.
                    </div>
                    <Input
                      label="email"
